...
//public int ID=Method.getMyID();
    public void setMessage(int ID, String ms) {
       // this.ID=ID;
        txt.setText(ms);
            System.out.println("send setmessage "+Method.getMyID());
            System.out.println("send setmessage "+Method.getMyName());
        if (Method.getFriends().get(ID).getImage() != null) {
            profile.setIcon(Method.getFriends().get(ID).getImage());
        }
    }

    public void setMessageold(String name,String ms) {
